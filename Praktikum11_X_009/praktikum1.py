...
L2 = Label(my_app, text = "Nama", font = ("Arial",14))
L2.grid(row = 1, column = 0)

str2 = StringVar(value = "Nadia Zerlinda")
...
str3 = StringVar(value = "L200194009")
...
str4 = StringVar(value = "Harry Potter")
...
str5 = StringVar(value = "Happy Ending")
